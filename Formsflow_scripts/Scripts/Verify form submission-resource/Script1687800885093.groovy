...
WebUI.setText(findTestObject('Business_Licence/search_form name'), findTestData('New Form Data').getValue(1, 5))
...
WebUI.setText(findTestObject('General tests/input_Name_formcomponenet'), findTestData('New Form Data').getValue(3, 3))

WebUI.setText(findTestObject('General tests/input_, numeric_formcomponent'), findTestData('New Form Data').getValue(3, 4))
